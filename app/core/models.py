...
from django.contrib.auth.models import AbstractBaseUser, BaseUserManager, \
                                        PermissionsMixin
from django.conf import settings  # use this to retrieve auth usermodel
...
class Tag(models.Model):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL,  # tags will be associated with users
        on_delete=models.CASCADE,  # if user is deleted; delete tags too
    )
